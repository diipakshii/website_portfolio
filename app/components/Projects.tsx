...
const categories: { label: string; emoji: string; projects: Project[] }[] = [
  {
    label: "Finance",
    emoji: "📈",
    projects: [
      {
        title: "Earnings Call Alpha Engine",
  ...
  },
  {
    ...
    projects: [
      {
        title: "Anchored Preference Optimization for Mathematical Reasoning",
        description: "Description",
  ...
  },
  {
    ...
    projects: [
      {
        title: "Social Media Data Management",
        description: "Description",
  ...
  },
  {
    ...
    projects: [
      ...
      {
        title: "Exoplanet Visualization Dashboard",
        description: "Description",
      ...
      },
      {
        ...
        description: "Description",
        tags: ["AI", "Constraint Satisfaction", "Python"],
        github: "https://github.com",
        demo: null,
      },
    ],
...
// Dynamically build the Featured tab from all categories
const allFeatured = categories.flatMap((c) => c.projects.filter((p) => p.featured));

const allCategories = [
  { label: "Featured", emoji: "⭐", projects: allFeatured },
  ...categories,
];

export default function Projects() {
  const [active, setActive] = useState(0);
  const current = allCategories[active];
            ...
            <button
              ...
              className={`flex items-center gap-2 px-5 py-2.5 rounded-full text-sm font-medium transition-all duration-200 ${
                active === i
                  ...
                  : "bg-pink-50 text-gray-500 hover:bg-pink-100 hover:text-pink-500"
              }`}
            >
              <span>{cat.emoji}</span>
              {cat.label}
    ...
    <div className="group relative bg-white border border-gray-100 rounded-2xl p-7 hover:border-pink-200 hover:shadow-xl hover:shadow-pink-50 transition-all duration-300 flex flex-col">
      ...
      <div className="flex items-start justify-between mb-4">
        <div className="flex items-center gap-2">
          ...
          {project.featured && (
            <div className="flex items-center gap-1 bg-amber-50 text-amber-400 border border-amber-100 px-2 py-0.5 rounded-full">
        ...
        <div className="flex items-center gap-3">
          {project.github && (
            <a href={project.github} target="_blank" rel="noopener noreferrer"
              className="text-gray-400 hover:text-pink-500 transition-colors" aria-label="GitHub">
          ...
          {project.demo && (
            <a href={project.demo} target="_blank" rel="noopener noreferrer"
              className="text-gray-400 hover:text-pink-500 transition-colors" aria-label="Live demo">
